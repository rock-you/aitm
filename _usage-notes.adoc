...
// margin notes - pdf only
ifdef::aitm-pdf[]
marginnote!XXXXXXXX.!marginnote
endif::aitm-pdf[]
...
(see <<fig-name-600-c>> footnote:[_Image credit httpsxxx, downloaded 2016-XXXX, commercial use permitted_])

[[fig-name-400-o]]
.xxxxxx
image::images/xxxxjpg[alttextxxx, 400, , float="left"]
...
xref:dual-axis-vc[dual-axis model]
...
xref:agile-doc-gap[agile issues with documentation]
