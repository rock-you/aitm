...
There are a wide variety of analysis techniques for making a business case at a more detailed level. Donald Reifer, in _Making the Software Business Case_ <<Reifer2002>>, lists:
