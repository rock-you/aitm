...
image::images/1.01-leanStartup.png[Lean Startup flowchart, 500,,float="left"]
...
image::images/1.01-BizModelCanvas.png[business model canvas,600, ]
...
image::images/1.01-BMC-example.png[author's business model canvas, 600]
