...
image::images/1_01-ITStates.png[IT States, 800]
...
We can combine the service experience (moment of truth) with the service/product lifecycle into the "dual-axis value chain" (originally presented in <<Betz2011a>>):

.Dual-axis value chain
image::images/1_01-2-axis-value-chain.png[2 axis value chain, 450, float="right"]
