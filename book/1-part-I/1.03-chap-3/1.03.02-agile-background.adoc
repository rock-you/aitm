...
.Waterfall lifecycle footnote:[similar to <<Royce1970>>]
...
.V-model footnote:[_Image credit https://en.wikipedia.org/wiki/V-Model_(software_development), downloaded 2016-11-12, public domain_]
image::images/1_03-vmodel.png[]
...
Failure after failure of this approach is apparent in the historical record (<<Glass1998>>). Recognition of such failures, dating from the 1960s, led to the perception of a “software crisis.”  (It should also be noted that many large systems were effectively constructed and operated during the "waterfall years", and that there are reasonable criticisms of the concept of a “software crisis” <<Bossavit2015>>).
