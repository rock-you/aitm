...
I prefer the saying that "servers are fleet vehicles, not collectible cars" as it seems less cruel (see <<fig-vehicles-500-i>> footnote:[Image credit https://www.flickr.com/photos/jacksnell707/15744307900/, https://www.flickr.com/photos/cokestories/6295871015/, downloaded 2016-11-10, commercial use permitted]), and the cattle metaphor overlooks the fact that large animal veterinarians are routinely employed in the cattle industry.
