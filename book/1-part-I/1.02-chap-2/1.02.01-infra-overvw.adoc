...
image::images/1_02-storage-disks.jpg[hard drives in array, 450, 200, float="left"]
...
image::images/1_02-network-connections.png[cables and equipment, 350, 200, float="right"]
