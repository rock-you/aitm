...
image::images/1_02-versionControlTypes.png[]
...
.Bitmap images
image::images/1_02-bothPixels.png[grid]
...
image::images/1_02-pixelHex1.png[data]

.Second image binary data
image::images/1_02-pixelHex2.png[data]
...
image::images/1_02-configMgmt.png[]
