...
Some monitoring covers low level system indicators not usually of direct interest to the end user. Other monitorines for end user experience, is an example of this. See <<Limoncelli2014>>, chapters 16-17.
