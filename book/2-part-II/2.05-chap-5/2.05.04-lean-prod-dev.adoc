...
image::images/2_05-lifecycle-table2.png[Cost of Delay table, 500]

.Product lifecycle, simple delay, charted
image::images/2_05-lifecycle-graph2.png[Cost of Delay graph, 500]
...
image::images/2_05-lifecycle-table3.png[Cost of Delay table, 500]

.Product lifecycle, aggravated delay, charted
image::images/2_05-lifecycle-graph3.png[Cost of Delay graph, 500]
