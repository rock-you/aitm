...
Advanced Cost of Delay analysis argues that different product lifecycles have different characteristics. The following set of charts 


Inability of PMs to estimate - reinertsen on variability

How to measure anything - it is better to reduce uncertainty than obsess over perfection.
