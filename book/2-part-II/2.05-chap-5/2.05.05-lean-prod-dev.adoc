...
control failure.  These ideas are well known to the Agile community and its authors. However, there is one thought leader who stands out in this field: an ex-Naval officer and former nuclear engineer named Donald Reinertsen.
...
But how do we reduce work in process? We have to _prioritize_. Do we rely on the xref:HIPPO[HIPPO] (Highest Paid Person's Opinion), or do we try something more rational? This brings us to the critical concept of _Cost of Delay_.
