...
David J. Anderson was a product manager at Microsoft who was seeking a more effective approach to managing software development. In consultation with Don Reinertsen (introduced in the xref:queuing[below]) he applied the original concept of Kanban to his software development activities <<Anderson2010>>.
...
image::images/2_05-queue.jpg[alt text, 300, 200, float="right"]
...
image::images/2_05-wip.jpg[alt text, 300, 200, float="left"]
