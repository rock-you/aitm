...
image::images/2.04-hippo.jpg[hippopotamus, 450,, float="left"]
...
.Impact map
image::images/2.04-impactMap.png[impact map, 550]
...
image::images/2.04-design2.jpg[Design sign,500,,]
...
image::images/2.04-geniusBar.jpg[Genius Bar, 400,,float="right"]
