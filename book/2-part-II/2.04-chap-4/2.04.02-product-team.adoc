...
image::images/2.04-psych-safety.jpg[happy faces, 400,,float="right"]
...
However, collaboration does not happen just because people are fed pizzas and work in a room together. Google has established that the most significant predictor of team performance is a sense of psychological safety (see sidebar).
...
image::images/2.04-VUF.png[venn diagram, 350, ,float="left"]
