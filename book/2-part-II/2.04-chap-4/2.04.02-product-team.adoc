...
One of the first prescriptive Agile methodologies you are likely to encounter as a practitioner is Scrum. There are many books, classes, and websites where you can learn more about this framework; cite:[Sims2012>> is a good brief introduction, and <<Rubin2012] is well suited for more in-depth study.
