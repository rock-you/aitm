...
.Value chain footnote:[Similar to cite:[Porter1998]]
...
image::images/3_09-hier2.png[Hierarchy, 700]
...
A useful framework for thinking about activities represented as icons is the IGOE approach, originated by the Process Renewal Group cite:[Burlton2001]. IGOE stands for:
...
===== Swimlanes
We made much of the fact that processes cross functions, and yet with our final diagram we have lost our view of this fact. We can re-introduce the functional boundaries through the use of swimlanes (pioneered by Rummler in cite:[Rummler1995]):
