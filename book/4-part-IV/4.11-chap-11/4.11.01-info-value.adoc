...
image::images/4_11-punchedCard.jpg[punched data card, 300,,float="left"]

.Card Sorter footnote:[_Image credit https://www.flickr.com/photos/pargon/2444932424, commercial use permitted_]
image::images/4_11-cardSorter.jpg[mechanical card sorting machine,400,,float="right"]
