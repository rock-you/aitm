...
image::images/4_11-conceptual.png[conceptual data model, 400]
...
.Logical data model
image::images/4_11-logical.png[logical data model, 400]
...
.Physical data model
image::images/4_11-physical.png[physical data model, 400]
