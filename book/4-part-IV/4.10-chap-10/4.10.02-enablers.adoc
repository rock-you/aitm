...
|Processes|xref:chap-coordination[Chapter 7]
|Organizational Structures|xref:chap-org-culture[Chapter 9]
|Culture, Ethics and Behavior|xref:culture[Chapter 9]
|Information|xref:chap-ent-info-mgmt[Chapter 11]
|Services, Infrastructure, and Applications|xref:Sec-I[Part I]
|People, Skills, and Competencies|xref:resource-mgmt[Chapter 9]
|====
