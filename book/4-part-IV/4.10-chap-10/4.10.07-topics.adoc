...
****
 ...
 https://en.wikipedia.org/wiki/Transactive_memory
  ...
  focus on intent of controls: As Jez Humble et al note cite:[Humble2013], "In many cases, onerous rules and GRC processes that are put in place are simply somebody’s interpretation of what is required, not mandated by the regulation in question.
