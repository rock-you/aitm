...
The four lifecycle model was first documented in cite:[Betz2011a]. The four lifecycles are:
...
The challenge in digital management is "lining up the lifecycles" so that transactional value flows across them (see <<fig-multilifecycle-800-c>> footnote:[similar to cite:[Betz2011a]).

[[fig-multilifecycle-800-c]]
.Multiple lifecycle model
image::images/4_00-multilifecycle.png[multi lifecycle problem, 800]
