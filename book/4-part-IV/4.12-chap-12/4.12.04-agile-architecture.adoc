...
* Despite a professed interest in systems theory, architecture has failed to adopt a workable systems perspectives on IT delivery. It did not recognize the fundamental problems of stage-gated delivery, big bang releases, queue proliferation, and so forth. Architecture "gap" analysis resulted in project recommendations, again "bringing the team to the work."
