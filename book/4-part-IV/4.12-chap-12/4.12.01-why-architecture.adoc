...
[[fig-serengeti-250-i]]
.The terrain
image::images/4_12-serengeti.jpg[alt text, 250, , float="left"]



[[fig-surveyor-200-i]]
.The mapmaker
image::images/4_12-surveyor.jpg[alt text, 200, , float="left"]

[[fig-map-235-c]]
.The map
image::images/4_12-map.jpg[alt text, 235, , float=""]

Confused? Consider the activity of map-making. In map-making you have:

* The actual terrain (<<fig-serengeti-250-i>> footnote:[Image credit https://www.flickr.com/photos/endogamia/3979040177, downloaded 2016-10-16, commercial use permitted])
* The capability of map making: surveying, drawing, etc. (<<fig-surveyor-200-i>> footnote:[Image credit https://www.flickr.com/photos/perspective/8474999166, downloaded 2016-10-16, commercial use permitted])
* The process of surveying and mapping it
* The resulting map as a document (<<fig-map-235-c>> footnote:[Image credit https://www.flickr.com/photos/martye_green/2354576085, downloaded 2016-10-16, commercial use permitted])
...
One of the most frequently used visualizations of enterprise architecture's concerns is the Zachman Framework (see <<fig-zachman-600>> footnote:[loosely based on cite:[Zachman1987] and succeeding work]).
