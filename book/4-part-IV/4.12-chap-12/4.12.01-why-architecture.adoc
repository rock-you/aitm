...
* If a xref:2_00.01-feedback[feedback] loop involves both line and staff organizations, it risks being delayed. The delay waiting for "headquarters approvals" has been a common theme in line/staff organizations.
...
These are not intangible suggestions. We have previously studied the work and influence of xref:2_04.04-lean-product-dev[Don Reinertsen], who emphasizes the critical importance of an economic model.
