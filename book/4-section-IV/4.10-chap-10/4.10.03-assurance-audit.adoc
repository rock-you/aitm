...
* IT processes such as Incident Management, Change Management, and Release Management with ITIL, CMMI-SVC,
...
illustration of gold and a ledger book

Money today represents a form of information. Bank deposits (our xref:what-is-IT-value[digital user's] bank account balance from Chapter 1) are no more than a computer record -- digital bits in memory -- made meaningful by tradition and law, and secured through multiple layers of protection and assurance.
...
ing a risk assessment and necessary audit procedures, and then reporting the results of an audit to management and the audit committee.<<Moeller2013>> p 324
