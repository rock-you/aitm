...
* The ISAE 3402/SSAE 16 data center audit standards
...
The ISAE 3402 standard is termed an "assurance" standard as well, with the full name _International standard on assurance engagements (ISAE) 3402: Assurance reports on controls at a service organization_. However, as mentioned above, this is the kind of "assurance" done in general by licensed auditors, and which might casually be called an "audit" by the participants.
