...
Compliance is also related but again distinct, as the concern for adherence to laws and regulations, and secondarily internal policy.
 ...
 discuss chapter order - security per se is strongly foreshadowed & prepped by gov/risk/assurance material

 Why is security "buried?" - refer to CISSP ordering, & nec precursors.
