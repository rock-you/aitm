...
Policies, even though more detailed than codes of ethics/conduct, still should be written fairly generally. In many organizations, they must be approved by the governing board.

There may be various levels of policy

Finally, policies reference *Standards and processes* and other enablers as appropriate. This is the management level, where specific
