...
* Detection
** monitoring events and alerts from intrusion detection and related operational systems, and responding as appropriate when security incidents are declared.

* Response
** Declaring security incidents and marshalling resources to combat
** Developing and executing response activities
...
And as with operations as a whole, there is ongoing monitoring and reporting to various stakeholders.
...
One of the most important operational processes from a security perspective is Change Management. From an Agile and digital perspective, this is often a controversial process, and this book recommends it be implemented in as automated a fashion as possible. ITSM Event and Incident Management may be leveraged as well.
