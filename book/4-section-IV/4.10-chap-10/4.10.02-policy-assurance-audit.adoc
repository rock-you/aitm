...
The lawyer said, "Um, that's an urban legend. The actual Nordstrom policy manual, while it starts off with that, runs about 8,000 words and covers a variety of topics such as handling customer information, using technology, social media, and so forth."
...
The HR director chimed in. "If we don't document our official position on things like sexual harassment and appropriate social media use we are going to have real problems. We could fire someone who has done something really bad, and they could sue us for wrongful termination. That could cost us real money." The lawyer nodded and the company owners looked thoughtful.
...
The lawyer said, "That's bad policy management. You need to keep your policies light and on the general side, and cover more detailed topics elsewhere. For example, the exact approach on how to reimburse employee expenses probably doesn't belong in the policy manual. Of course, that means that somewhere you need to lay out how policies are implemented by processes, procedures, guidelines, and so forth."

Another said, "This is all getting complex."

"Yes, complexity is to some extent unavoidable as you move to this new scale. You need to keep outcomes in mind, and continue to push as much decision making down to individuals as you can. 'Use good judgment is still a great place to start.'"
