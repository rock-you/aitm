...
====== Principles, Policies, and Frameworks
====== Processes
We will discuss enablers as controls in the next section on risk and control. A control is a role that an enabler may play. Processes are the primary form of enabler used in this sense. 
