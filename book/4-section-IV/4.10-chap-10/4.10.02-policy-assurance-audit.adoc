...
The *Principles and codes* should also be brief. For example, Nordstrom's is about 8,000 words, perhaps about 10 pages.

*Policies* are more extensive. Policies are often independently maintained documents, perhaps organized along lines similar to:
...
Finally, policies reference *Standards and processes* and other enablers as appropriate. 
