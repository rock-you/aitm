...
This is a blurry boundary in practice, as an assurance engagement may be undertaken by auditors, and then might be casually called an "audit" by the parties involved. And there is a spectrum of activities that seem at least to be related to formal assurance:
...
* Other forms of capability assessment
* Vendor evaluations
** SAS70
