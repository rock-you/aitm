...
Assurance in practice may seem to be biased towards risk management, but (as with governance in general) assurance as a whole relates to all aspects of IT governance, including effectiveness and efficiency.
...
Larger organizations often have a "Risk Management" function. In general, the scope of Risk Management includes:

* Identifying risks
* Assessing and prioritizing them
* Coordinating effective responses to risks
* Ongoing monitoring of risk responses and controls effectiveness
