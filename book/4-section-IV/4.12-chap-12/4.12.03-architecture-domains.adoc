...
Let's compare and contrast the business model versus the operating model, and in the same analysis consider the distinction between enterprise architecture and business architecture. Can enterprise architecture be equated with the operating model? If business architecture is a subset of enterprise architecture, does that mean it also is primarily concerned with the operating model? Or is business architecture also concerned with the business model? Perhaps the best definition is that business architecture is the component of enterprise architecture most concerned with the enterprise business model as opposed to the enterprise operating model. In the final analysis, all this book can do is recommend caution and careful inquiry for readers who find themselves in the midst of such debates, which can become quite contentious.

Leaving aside these abstract debates, there are a number of concerns that business architecture includes:
