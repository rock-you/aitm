...
And one discipline (Information and Data architecture) that corresponds to an entire column (Passive Structure, or "What" in Zachman terms). For evidence, see the Data Management Body of Knowledge <<DAMA2009>>, which covers the gamut of information and data topics from high level glossaries all the way down to physical database administration.
