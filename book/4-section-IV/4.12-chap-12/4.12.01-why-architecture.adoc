...
image::images/4.12-architecture.jpg[alt text, 900, , float=""]
...
image::images/4.12-EA-context.png[EA context, 900]
...
image::images/4.12-BM-OM.png[Business model versus operating model, 900]
