...
image::images/4.12-architecture.jpg[alt text, 500, 200, float=""]
...
image::images/4.12-serengeti.jpg[alt text, 250, 200, float="left"]
...
image::images/4.12-surveyor.jpg[alt text, 200, 200, float="left"]
...
image::images/4.12-map.jpg[alt text, 235, 200, float=""]
...
image::images/4.12-EA-context.png[EA context, 500]
...
image::images/4.12-BM-OM.png[Business model versus operating model, 500]
