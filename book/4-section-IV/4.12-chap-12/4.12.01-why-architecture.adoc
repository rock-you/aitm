...
* A reduced technology portfolio can and should result in more favorable vendor terms, improved support, improved security, reduced IT staffing spend, and potentially reduced development time
* Better understanding of the current estate should reduce investigation times and outages, and reduce the risk of regulatory violations
...
We have covered the concept of xref:cost-of-delay[Cost of Delay] previously, at the level of product feature. However, this powerful concept can also be applied at higher levels.

Cost of Delay is not a concept familiar to most architects, but 
