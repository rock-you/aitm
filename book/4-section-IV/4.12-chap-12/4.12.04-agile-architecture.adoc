...
As in the line/staff discussion - war, for better or worse, is one of the most complex phenomena ... if a line/staff structure is deemed insufficient, the burden is on those saying so to propose something superior. Scrum of Scrums is just naive.
