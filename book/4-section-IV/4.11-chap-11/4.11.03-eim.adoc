...
Data is not just an internal artifact of organizations. Data can be bought and sold on the open market like any other commodity. Marketing organizations frequently acquire contact information for email and other campaigns. More specialized market data includes (for example):
...
and many more. (Notice the term "market data" can be understood as "data about markets" or more broadly as "data acquired from a market.")
