...
When data is highly persistent and used for many purposes across an enterprise, we may call it  "reference" data. Classic examples of master data include:
...
Reference data is not all of master data however. Master data is a much broader topic.
