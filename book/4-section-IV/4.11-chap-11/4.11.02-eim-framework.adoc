...
Databases are the physical representation of information within computing systems. The data contained within them *corresponds* to some "real world" concept we hold.
