...
*Note, the below section is illustrative only, and is not intended as a lab. The associated lab for this book goes into depth on these topics.*
...
image::images/1.02-iac.png[folders/files,300, , float="left"]
