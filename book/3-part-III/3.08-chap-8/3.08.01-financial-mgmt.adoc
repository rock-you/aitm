...
The idea that "Real Options" were a basis for Agile practices was proposed by Chris Matts <<Matts2007>>. Investment banker turned Agile coach Franz Ivancsich strongly cautions against taking options theory too far, noting that to price them correctly you have to determine the complete range of potential values for the underlying asset <<Ivancsich2013>>.
