...
The State of DevOps research has demonstrated a correlation between generative cultures and digital business effectiveness cite:[Puppet2015>>, <<Forsgren2016]. Notice also the relationship to xref:blameless-postmortems[blameless postmortems] discussed in Chapter 6.
