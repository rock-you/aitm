...
We've discussed xref:2_05.00-work-management[work management], which is an important precursor of process management. Work management is less formalized; a wide variety of activities are handled through flexible xref:2.05.02-kanban[Kanban]-style boards or "card walls" based on the simplest "process" of:
...
We also introduce process in terms of our xref:0_01-emergence[emergence model], and therefore focus on the concerns and dynamics that may cause you to notice the concept, and your need for it.
