...
We have previously discussed product and project management, and the beginnings of xref:IT-process-emergence[IT process]. You may wish to review our summary description of xref:2.04.01-process-project-product[process, product, and project management].
