...
We have previously discussed product and project management, and the beginnings of xref:IT-process-emergence[IT process]. You may wish to review our summary description of xref:2_04.01-process-project-product[process, product, and project management].
...
As we know from our discussion of xref:2_04.00-product-mgmt[Product Management], developing new products is not a particularly repeatable process. The Agile movement in some ways arose in opposition to attempts to apply process concepts of "repeatability" to developing software. These concerns remain.
