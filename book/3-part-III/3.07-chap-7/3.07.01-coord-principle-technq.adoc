...
Strode et al provide a useful framework for understanding coordination mechanisms, excerpted and summarized into <<tbl-coord-tax>>.
...
[[tbl-coord-tax]]
.Coordination taxonomy table footnote:[adapted from cite:[Strode2012]
[cols="3*", options="header"]
|====
