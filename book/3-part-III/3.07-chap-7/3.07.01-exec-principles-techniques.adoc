...
What is a "dependency"? We need to think carefully about this. It's intuitive that 

Dependency taxonomy
Coordination strategy (similar to delivery model)
Coordination effectiveness (success criteria)
