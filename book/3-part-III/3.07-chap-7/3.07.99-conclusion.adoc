...
The history of Scrum is relevant, in particular cite:[Schwaber2002]. Critiques of statistical process control for software are found in cite:[Binder1997] and cite:[Raczynski2008].
