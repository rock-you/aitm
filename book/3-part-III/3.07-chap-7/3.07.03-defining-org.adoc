...
There is a broad agreement that multi-tasking destroys productivity and even mental health <<Cherry2016>>. Therefore, selecting organization structures that minimize multi-tasking is important. Structures that enable teams to work without depending on outside resources are less likely to promote multi-tasking, which emerges as a natural response when one activity becomes blocked (e.g. due to needing another team's contribution).
