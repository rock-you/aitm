...
The history of industrial engineering is often controversial, however.
...
.Process control chart footnote:[]
image::images/3_09-controlChart.jpg[_image from https://www.flickr.com/photos/internetarchivebookimages/14775750673/, no known copyright restrictions_]
