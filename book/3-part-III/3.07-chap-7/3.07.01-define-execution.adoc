...
** Cadence
 ...
 defining execution
includes coordination in the short time frame
...
As we discussed in  xref:chap-org-culture[Chapter 7], we are introducing multiple feature teams as our product scales up:
...
===== Dependencies and other concepts
