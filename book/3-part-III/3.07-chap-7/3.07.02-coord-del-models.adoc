...
We discussed the xref:process-mgmt-emerges[emergence of process management] in Chapter 5, and you should also review the xref:process-modeling[overview in the appendix].
