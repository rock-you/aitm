...
We discussed the xref:process-mgmt-emerges[emergence of process management] in Chapter 5, including the basic processes of Change, Incident, Problem, and Request management, and you should also review the xref:process-modeling[overview in the appendix].
