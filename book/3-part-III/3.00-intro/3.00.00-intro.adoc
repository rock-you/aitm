...
Digital professionals use a number of approaches to defining and managing work at various scales. We previously discussed the "3 Ps" of xref:process-project-product[process, product, and project management]. They represent one dimension. Part III is ordered along another dimension we will call delivery model. This special section provides a necessary overview to understanding Part III.
...
NOTE: In terms of classic project methodology, chapter 8 includes project initiating and planning. Execution, monitoring, and control are covered in Chapter 9.
