...
As you become a manager of managers, your concerns again shift. In Part II, you had to delegate xref:product-mgmt-chap[product management] (are they building the right thing?) and take concern for basic xref:work-management[task management] and xref:ops-mgmt[digital operations]. Now, as your organization grows, you are primarily a manager of managers, concerned with providing the conditions for your people to excel:
...
*Chapter 7: Execution and coordination*
