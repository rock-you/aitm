...
we get the Betz organizational scaling cube. It shows the three dimensions we'll consider throughout Part III. The accompanying cube shows these dimensions visually. It will be applied to examples in subsequent sections. The three dimensions represent a space to understand work, resource, and planning as we scale the organization.
