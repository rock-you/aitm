...
Part II can be viewed as a logical progression from the uncertainty of developing a novel product, to the day to day work of building its features, to its predictable operation. The "predictability curve" illustrated in the associated figure increases as the digital product stabilizes and moves to a fully operational state.

This question of variation, of *the degree to which actuals track estimates* and can be known in advance, will be an ongoing theme throughout Part III. As we scale up, our organization takes on more and more work of all kinds, from highly uncertain to very predictable. Understanding the differences in this "portfolio" of work is essential to managing it correctly. 

==== Time frames

In general, as an organization scales, there is an increasing span in time frame and scope of work being considered and executed. First, the chapter structure of Part III can be visualized thus:
