...
.All hands meeting at NASA Goddard footnote:[_Image credit https://www.flickr.com/photos/gsfc/10026603395, downloaded 2016-11-28, commercial use permitted_]
image::images/3_00-team-of-teams.jpg[Large meeting, 500, 200, float="right"]
...
Digital professionals use a number of approaches to defining and managing work at various scales. We previously discussed the "3 Ps" of xref:process-project-product[process, product, and project management]. They represent one dimension. Part III is ordered along another dimension we will call urgency. This special section provides a necessary overview to understanding Part III.

*Chapter 7: Culture and organization*

What are the unspoken assumptions that underly our daily work -- in other words, what is our culture? Does our culture support high performance, or the opposite? How can we measure and know such a thing? We're getting big.  How are we formally structured? In terms of our market, or in terms of our resources? How are people grouped, and to whom do they report, with what kind of expectations?  Finally, what is our approach to bringing new people into our organization?

*Chapter 8: Investment*

In order to keep growing, you have to divide your organization. You've chosen an approach for structuring your organization, but each product, project, or service also represents a deliberate investment decision. You now have a portfolio of features, and/or products. You need a strategy for choosing among your options and planning -- at least at a high level -- in terms of costs and benefits. Some of you may be using project management to help manage your investments. Your vendor relationships continue to expand; they are another form of strategic investment, and you need to deepen your understanding of things like Cloud contracts and software licensing. Finally, what is your approach to finance and budgeting?

NOTE: In terms of classic project methodology, this chapter includes project initiating and planning. Execution, monitoring, and control are covered in Chapter 9.

*Chapter 9: Execution*

When is work repeatable? When is it unique? Understanding the difference is essential to your organization's success. Is variability in the work always bad? How do you ensure that the work is getting done, and that teams are coordinating effectively? Some argue that you don't need project management at all any more - it's all about continuous flow through product organizations. But you've seen that your most ambitious ideas require some kind of choreography, and that products and projects need certain resources and services delivered with a predictable process. And when resources are tight (and when aren't they?) their consumption must be governed somehow.
